...
const topics = [
  ...
  storyTitleTopic({
    ...
    title: "يحبها ولد عمها الغيووور ويجننها بغيرته الحلوه.. !",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Theo Đuổi Crush Không Thành, Tôi Vừa Bỏ Cuộc Anh Liền Phát Điên",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Sovereign Of Immortals（Xianxia Novel, 350K Words Updated.）",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "To Love You Was A Crime Against Reality",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "دوستويفسكي (من أفضل أعماله",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "【 】công Lược Thất Bại, Nữ Phụ Tôi Đây Không Thèm Diễn Nữa",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Sau Khi Bị Bỏ Rơi Tôi Khiến Anh Quỳ Xuống",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Giữa Loạn Thế, Tôi Ôm Thai Chạy Khỏi Thiếu Soái",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "The System Maker [A Programmer's DIY LitRPG / Weak To Strong]",
    enMotif: "suspense and mystery and fantasy adventure",
    viMotif: "kinh dị bí ẩn và tiên hiệp fantasy",
    hiMotif: "सस्पेंस और रहस्य और फ़ैंटेसी एडवेंचर",
    idMotif: "misteri dan ketegangan dan petualangan fantasi",
  ...
  storyTitleTopic({
    ...
    title: "Throne Of Time [Magical Academy, Time Loop, Mystery]",
    enMotif: "suspense and mystery and fantasy adventure",
    viMotif: "kinh dị bí ẩn và tiên hiệp fantasy",
    hiMotif: "सस्पेंस और रहस्य और फ़ैंटेसी एडवेंचर",
    idMotif: "misteri dan ketegangan dan petualangan fantasi",
  ...
  storyTitleTopic({
    ...
    title: "A Mage Regressor LitRPG [STUBBING OCTOBER 20TH]",
    enMotif: "suspense and mystery and fantasy adventure",
    viMotif: "kinh dị bí ẩn và tiên hiệp fantasy",
    hiMotif: "सस्पेंस और रहस्य और फ़ैंटेसी एडवेंचर",
    idMotif: "misteri dan ketegangan dan petualangan fantasi",
  ...
  storyTitleTopic({
    ...
    title: "The Lich King Reincarnates As A Baby [B1 STUBBING OCT 3RD]",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Trùng Sinh, Tôi Chọn Nam Phụ Để Yêu",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Hóa Ra Kẻ Thù Từ Bé Lại Rất Nghiện Tôi",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Disuruh Baca @ledib X @ayoncakra Malah Aku Kena Mental !",
    enMotif: "suspense and mystery",
    viMotif: "kinh dị bí ẩn",
    hiMotif: "सस्पेंस और रहस्य",
    idMotif: "misteri dan ketegangan",
  ...
  storyTitleTopic({
    ...
    title: "Hoa Khôi Thở Dốc Vì Mặc Áo Đồng Phục Triết Eo Hết Cỡ",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "The Primordial Vampire of House Vaust",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Hôn Mê 10 Năm Ba Đưa Em Vẫn Sợ Chị Gái",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "My Sheriff Wife Handcuffed Our 10-Year-Old Son During A Flood",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Everyone Thought I Was Weak, Until I Cast A Million Fireballs! (LITRPG/EPIC PROGRESSION)",
    enMotif: "suspense and mystery and fantasy adventure",
    viMotif: "kinh dị bí ẩn và tiên hiệp fantasy",
    hiMotif: "सस्पेंस और रहस्य और फ़ैंटेसी एडवेंचर",
    idMotif: "misteri dan ketegangan dan petualangan fantasi",
  ...
  storyTitleTopic({
    ...
    title: "Bị Cướp Hết Dự Án, Tôi Nghỉ Việc Khiến Công Ty Lao Đao",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "عندما يقع الشيطان في العشق",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "HOA KHÔI LỚP THÍCH KHOE LÀN DA TRẮNG ĐỂ QUYẾN RŨ NAM THẦN @CatCatAudit ​",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Tôi Không Phải Là Cái Bóng Của Người Anh Yêu",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Dinner At the Beach House",
    enMotif: "web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "بعد ٦ سنوات حب خطب غيري سراً ويوم تركتُه ركع تحت الثلج يبكي ويقول",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Trà Xanh Mới Chuyển Vào Lớp Tôi Thích Nhõng Nhẽo",
    enMotif: "green tea rival",
    viMotif: "trà xanh",
    hiMotif: "छल भरी प्रतिद्वंद्वी",
    idMotif: "rival bermuka dua",
  ...
  storyTitleTopic({
    ...
    title: "Hoa Khôi Đòi Thay Đồng Phục Cả Trường",
    enMotif: "school romance",
    viMotif: "vườn trường",
    hiMotif: "कॉलेज रोमांस",
    idMotif: "romansa sekolah",
  ...
  storyTitleTopic({
    ...
    title: "बड़े बिजनेसमैन ने दी धमकी, लड़की ने फाड़ दिया करोड़ों का एग्रीमेंट!",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
  ...
  storyTitleTopic({
    ...
    title: "Tôi Phải Ở Ké Nhà Kẻ Thù Từ Bé",
    enMotif: "Vietnamese web fiction and romance drama",
    viMotif: "truyện mạng Việt và romance drama",
    hiMotif: "हिंदी वेब स्टोरी और रोमांस ड्रामा",
    idMotif: "cerita online dan drama romansa",
